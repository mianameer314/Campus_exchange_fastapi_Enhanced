...
Revision ID: 325f6e4ea397
Revises: 
Create Date: 2025-08-17 22:25:05.830513
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('listing_id', 'participant1_id', 'participant2_id', name='uq_chat_room')
    )
